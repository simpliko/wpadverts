...
<div class="wrap">
    <h2 class="nav-tab-wrapper">
        <a href="<?php esc_attr_e( remove_query_arg( array( 'edit', 'adaction' ) ) ) ?>" class="nav-tab nav-tab-active"><?php _e("Options", "wpadverts") ?></a>
        <a href="<?php esc_attr_e( add_query_arg( array('adaction'=>'list') ) ) ?>" class="nav-tab "><?php _e("Pricing", "wpadverts") ?></a>
    </h2>
