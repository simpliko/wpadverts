<div class="wpadverts-cpt <?php echo sprintf( "wpadverts-cpt-", $atts["post_type"] ?? '' ) ?> wpadverts-cpt-data-table wpadverts-cpt-data-table-list atw-w-full atw-flex atw-flex-col">
    <div class="atw-grid atw-grid-cols-1 md:atw-grid-cols-1 atw-border-x-0 atw-border-b-0 <?php if( $atts["closed_top"] ?? false ): ?>atw-mt-6 atw-border-t<?php else: ?>atw-border-t-0<?php endif; ?> atw-border-solid atw-border-gray-100">
