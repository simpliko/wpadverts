...
* FIXED: Error when submitting a contact form.

= 2.2.9 - 2025-12-01 =

* FIXED: Web accessibility (ADA) improvments for blocks.
* FIXED: Few typos fixed.
* FIXED: Warning generated by the wpadverts_block_button() function.
...
* FEATURE: New Plugin Elementor Integration.
* LANGUAGE: Updated NL translation.
* FIXED: Warning in the Contact Methods block with default contact methods.
* FIXED: Contact methods not detecting visible contact methods correctly (on the Ad details pages).
* FIXED: Warning in the Classifieds Manage block.
* FIXED: Ability to style the block buttons and forms individually.
...
* FIXED: Vulnerability in the Classifieds Single Date Table block
* FIXED: Vulnerability in the Classifieds Single Author block
* FIXED: Reverted wrapping the long titles in the Classifieds List block
...
* FEATURE: Additional configuration options for the Classifieds Single Author block.
* FEATURE: Additional configuration options for the Classifieds Single Contact block.
* FEATURE: Ad details pattern with contact details in the sidebar.
