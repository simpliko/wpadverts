...
<div class="wpa-picture-grid wpa-block-list-view-grid atw-flex atw-grow">
    ...
    <?php elseif($data->default_image_url): ?>
        <img src="<?php echo esc_attr( $data->default_image_url ) ?>" class="atw-w-full atw-max-w-full atw-max-h-full atw-block atw-rounded-none atw-border-0 atw-shadow-none" title="" alt="" />
    <?php else: ?>
